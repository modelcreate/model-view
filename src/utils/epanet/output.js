...
// {{PRE_LIBRARY}}
  ...
  var _stderr=18880;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
  ...
  var ___tm_current=18928;
  
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 18976, 4), 18976);
...
Module["asm"] = asm;
var _ENgetversion = Module["_ENgetversion"] = function() {  return Module["asm"]["_ENgetversion"].apply(null, arguments) };
...
var _epanet_run = Module["_epanet_run"] = function() {  return Module["asm"]["_epanet_run"].apply(null, arguments) };
...
var _solve = Module["_solve"] = function() {  return Module["asm"]["_solve"].apply(null, arguments) };
